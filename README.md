...
- A TypeScript, Python, or JavaScript codebase for the staleness gate (per-symbol for TS and Python, whole-file for JS) — other file types are surfaced via registration, not judged (see "Language support")
