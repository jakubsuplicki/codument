...
- A TypeScript, Python, Go, Rust, JavaScript, or Vue/Svelte/Astro codebase for the staleness gate (per-symbol for TS/Python/Go/Rust, per-part for components, whole-file for JS) — other file types are surfaced via registration, not judged (see "Language support")
