...
- **Motion**: Use animations for effects and micro-interactions. Prioritize CSS-only solutions for HTML. Use Motion library for React when available. Focus on high-impact moments: one well-orchestrated page load with staggered reveals (animation-delay) creates more delight than scattered micro-interactions. Use scroll-triggering and hover states that surprise. **For any non-trivial motion decision — whether something should animate at all, easing/duration/spring choice, drawers/toasts/sheets, gestures and drag-to-dismiss, origin-aware popovers, reduced-motion, or reviewing/debugging janky motion — invoke the `motion-craft` skill** (covers both web and React Native). It carries the full decision framework this bullet only gestures at; don't hand-roll motion beyond a basic transition.
