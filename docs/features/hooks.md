...
- Inside the block: a red strict gate blocks the commit with both escapes named; a missing gate binary warns and lets the commit pass. *(untested — the end-to-end commit-blocking test lands with the `hooks` command)*
